...
Tip: 30fps · 1080p · 2–3 seconds per clip works best.
3. Import Videos → Extract Landmarks
python video_importer.py --review
# or
python video_importer.py
4. Train the Model
python train.py
...
Clips per word	30+
░░ Collaborative Training
The more contributors, the better the model generalizes.
░░ Portability
Scenario	What to copy	Retrain?
New PC	models/ + code	❌
Add signs	full project	✅
Share model	model files	❌
░░ Requirements
Python 3.10+
mediapipe
tensorflow (CPU)
...
<div align="center">
Hand-Bridge — Connecting hands to words.
